...
void ImGuiDebugger::initialize() {
   ...
   //ImGui_ImplWin32_EnableDpiAwareness();
	...
	debugWindow = hwnd;
    //deserialize("dbMapData.bin", dbInstrMap);
...
ImGuiDebugger* ImGuiDebugger::g_debugger;
void ImGuiDebugger::initStatic()
{
    g_debugger = new ImGuiDebugger();
}
