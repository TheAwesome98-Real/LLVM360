...
{
public:
	inline XexImage* GetImage() const { return m_image; }

	inline const std::string& GetName() const { return m_name; }
	inline const uint32_t GetVirtualOffset() const { return m_virtualOffset; }
	inline const uint32_t GetVirtualSize() const { return m_virtualSize; }
	inline const uint32_t GetPhysicalOffset() const { return m_physicalOffset; }
	inline const uint32_t GetPhysicalSize() const { return m_physicalSize; }
...
public:
	...
	inline const uint32_t GetMemorySize() const { return m_memorySize; }
	inline const uint8_t* GetMemory() const { return m_memoryData; }

	inline const uint64_t GetBaseAddress() const { return m_baseAddress; }
	inline const uint64_t GetEntryAddress() const { return m_entryAddress; }

	inline const uint32_t GetNumSections() const { return (uint32_t)m_sections.size(); }
	inline const Section* GetSection(const uint32_t index) const { return m_sections[index]; }
